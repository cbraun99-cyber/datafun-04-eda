...
5. Ensure the file is saved with the `.md` extension.

Alternatively, you can use this Python code to create the file directly:
...
Run this Python code, and it will generate the `README.md` file for you.